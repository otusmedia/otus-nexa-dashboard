  ...
  return (
    <div className={cn("fixed right-6 z-40 flex flex-col items-end gap-3", bottomClass)}>
      ...
      <button
        ...
        className="relative flex h-11 w-11 items-center justify-center rounded-full text-[rgba(255,255,255,0.55)] transition hover:text-white"
        style={{
      ...
      >
        ...
        {!chat.open && chat.unreadTotal > 0 ? (
          <span className="absolute -right-0.5 -top-0.5 flex h-4 min-w-4 items-center justify-center rounded-full border border-white/15 bg-[#FF4500] px-1 text-[9px] font-semibold text-white">
