...
export function getGa4DashboardMock(error?: string): Ga4DashboardResponse {
  return {
    source: "mock",
    ...(error ? { error } : {}),
    totals: {
      sessions: "58,420",
      bounceRate: "38.2%",
      avgSessionDuration: "03:18",
      changes: { sessions: "+7.1%", bounceRate: "-2.4%", avgSessionDuration: "+0:22" },
    },
    topPages: [],
  };
}
